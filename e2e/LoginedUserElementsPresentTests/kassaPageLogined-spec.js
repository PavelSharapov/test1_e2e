...
let LoginedUserKassaPage = require('../PageObgects/kassaPageLogined-objects');
...
describe('Kassa page sections:', function () {
    let loginedUserKassaPage = new LoginedUserKassaPage();
    let headerFooterLogined = new HeaderFooterLoginedUser();
    //let logInHelper = new Login();
    // logInHelper.logIn('p1','44445678t');
    it(' open Kassa page', function () {
        loginedUserKassaPage.getKassaPage();
    });
    ...
    describe('Table column titles present:', function () {

        it('should displayed 1st column title', function () {
            expect(loginedUserKassaPage.kassaTableColumn1Title.isDisplayed()).toBe(true);
        });
        it('should displayed 2nd column title', function () {
            expect(loginedUserKassaPage.kassaTableColumn2Title.isDisplayed()).toBe(true);
        });
        it('should displayed 3rd column title', function () {
            expect(loginedUserKassaPage.kassaTableColumn3Title.isDisplayed()).toBe(true);
        });
        it('should displayed 4th column title', function () {
            expect(loginedUserKassaPage.kassaTableColumn4Title.isDisplayed()).toBe(true);
        });
        it('should displayed 5th column title', function () {
            expect(loginedUserKassaPage.kassaTableColumn5Title.isDisplayed()).toBe(true);
        });
    });
