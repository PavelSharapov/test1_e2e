...
let HeaderFooterLoginedUser = function () {
    ...
    this.footerContactsLink = $$('footer .footer-link').get(0);
    this.footerMethodsLink = $$('footer .footer-link').get(1);
    this.footerTermsLink = $$('footer .footer-link').get(2);
    this.footerSecurityLink = $$('footer .footer-link').get(3);
    this.footerFaqLink = $$('footer .footer-link').get(4);
    this.footerBonusTermsLink = $$('footer .footer-link').get(5);
    this.footerAffiliatesLink = $$('footer .footer-link').get(6);
